...
import static com.example.embryo.ImprovedSentimentAnalysis.analyzeSentiment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    speechManager.startSpeak("Hi, You can ask anything or questions related to embryo innovation center from me,  by touching my head ", MySettings.getSpeakDefaultOption());
