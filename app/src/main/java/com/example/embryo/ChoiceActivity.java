        ...
        MySettings.initializeSpeak();
            ...
            delayHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                        ...
                        speechManager.startSpeak("we started with Raccoon AI,  then IIOT dev kit,  Smart Agro,  Uni vo , at last IIOT CMS, if you want to know anything of that product please type on my screen ", MySettings.getSpeakDefaultOption());
