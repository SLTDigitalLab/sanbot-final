package com.example.embryo;


import static com.example.embryo.MyUtils.concludeSpeak;
import static com.example.embryo.MyUtils.rotateAtRelativeAngle;
import static com.example.embryo.MyUtils.sleepy;
import static com.example.embryo.MyUtils.temporaryEmotion;
...
public class HandShake extends TopBaseActivity {
    ...
    public void firstMeeting() {
         ...
         */
        speechManager.startSpeak("Hi, I am emy, Give me your hand ", MySettings.getSpeakDefaultOption());
    ...
    public void shakeHand() {
        ...
        speechManager.startSpeak("Hi, Nice to meet you, Lets see about embryo innovation center ", MySettings.getSpeakDefaultOption());
        concludeSpeak(speechManager);
    ...
    public void timeWaitingExpired() {
        ...
        speechManager.startSpeak("No handshake , ok lets move on, Lets see about embryo innovation center", MySettings.getSpeakDefaultOption());
        concludeSpeak(speechManager);
